...
class Distribution:
    """This class represents a discrete distribution.
       offset is the start index, values is the list contains all the probability 
    """
    ...
    # returns the value of probabilty at position index
    ...
    #preprocesser to polt the distribution of a list
