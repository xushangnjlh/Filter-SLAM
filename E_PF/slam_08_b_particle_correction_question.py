...
class ParticleFilter:
    ...
    def predict(self, control):
        """The prediction step of the particle filter, which is the motion model."""
        left, right = control
    ...
    def h(state, landmark, scanner_displacement):
        """Takes a (x, y, theta) state and a (x, y) landmark, and returns the
           corresponding (range, bearing). This the perception model."""
    ...
    def probability_of_measurement(self, measurement, predicted_measurement):
        ...
        # predicted_measurement is obtained from the known position of the landmark
        # while measurement is from the real measurement 
...
if __name__ == '__main__':
    ...
    control_turn_factor = 0.60  # Additional error due to slip when turning.
