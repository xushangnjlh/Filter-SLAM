...
class ParticleFilter:
    ...
    def predict(self, control):
        ...
        for i in xrange(len(self.particles)):
            ...
            # deviation = self.particles[i]
            new_left = random.gauss(left, sqrt(left_variance))
            new_right = random.gauss(right, sqrt(right_variance))
            self.particles[i] = self.g(state,(new_left,new_right),self.robot_width)
