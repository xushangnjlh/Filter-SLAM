# Python routines useful for handling LEGO robot data.
# Author: XU Shang, 2016-10-07
...
# The logfile can parse these data:
...
# L landmark (reference landmark, fixed (known!))
...
class LegoLogfile(object):
    ...
    def read(self, filename):
        ...
        for l in f:
            ...
            # M denotes the motor data, only interested in sp[2] and sp[6]
            # first_motor_ticks is the flag to indicate whether the motor_ticks list should be 
            # cleared. ticks and last_ticks tuple stands for absoulte ticks read from motor tick
            # so that motor_ticks store relative ticks (movement) for left and right motor.
            elif sp[0] == 'M':
