...
# Initially, all in world_extends are 0 
...
def dijkstra(start, goal, obstacles):
    ...
    # So the front list consists tuples made of vertex cost and vertex position.
    front = [ (0.0, start) ]
    ...
    while front:
        ...
        cost_list = [i[0] for i in front]
        min_index = cost_list.index(min(cost_list))
        element = front[min_index]
        ...
        # Check all neighbors of the this newly visited vertex
        for dx, dy, deltacost in movements:
            ...
            # May add vertex already in front, but not visited!
