...
class Particle:
    ...
    def initialize_new_landmark(self, measurement_in_scanner_system,
        ...
        measure_in_world_system = LegoLogfile.scanner_to_world(scanner_pose,measurement_in_scanner_system)
        H = self.dh_dlandmark(self.pose,measure_in_world_system,scanner_displacement)
